...
export VLLM_GDN_CHUNK_SIZE="${VLLM_GDN_CHUNK_SIZE:-64}"
export FLA_GDN_FIX_BT="${FLA_GDN_FIX_BT:-0}"
export FLA_TRIL_PRECISION="${FLA_TRIL_PRECISION:-ieee}"
export FLA_GDN_DOT_PRECISION="${FLA_GDN_DOT_PRECISION:-}"
export VLLM_GFX936_FUSED_GATE_UP_SILU="${VLLM_GFX936_FUSED_GATE_UP_SILU:-0}"
export VLLM_TRITON_PREFILL_NUM_WARPS="${VLLM_TRITON_PREFILL_NUM_WARPS:-}"
export VLLM_TRITON_PREFILL_DOT_PRECISION="${VLLM_TRITON_PREFILL_DOT_PRECISION:-}"
...
echo "VLLM_GDN_CHUNK_SIZE=$VLLM_GDN_CHUNK_SIZE"
echo "FLA_GDN_FIX_BT=$FLA_GDN_FIX_BT"
echo "FLA_TRIL_PRECISION=$FLA_TRIL_PRECISION"
echo "FLA_GDN_DOT_PRECISION=${FLA_GDN_DOT_PRECISION:-unset}"
echo "VLLM_GFX936_FUSED_GATE_UP_SILU=$VLLM_GFX936_FUSED_GATE_UP_SILU"
echo "VLLM_TRITON_PREFILL_NUM_WARPS=${VLLM_TRITON_PREFILL_NUM_WARPS:-unset}"
echo "VLLM_TRITON_PREFILL_DOT_PRECISION=${VLLM_TRITON_PREFILL_DOT_PRECISION:-unset}"
