...
case_lines_quick=(
  "mid_4_8|experiment/tile64-mid-default-20260709|mid|16|0|4-8K|3"
  "mid_8_16|experiment/tile64-mid-default-20260709|mid|16|0|8-16K|3"
  "mid_gdn16_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|16|0|4-8K|3"
  "mid_gdn16_fla_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|16|1|4-8K|3"
)

case_lines_gdn=(
  "mid_gdn8_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|8|0|4-8K|3"
  "mid_gdn16_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|16|0|4-8K|3"
  "mid_gdn32_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|32|0|4-8K|3"
  "mid_gdn16_fla_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|16|1|4-8K|3"
)
...
case_lines_full=(
  "mid_4_8|experiment/tile64-mid-default-20260709|mid|16|0|4-8K|3"
  "mid_8_16|experiment/tile64-mid-default-20260709|mid|16|0|8-16K|3"
  "mid_16_32|experiment/tile64-mid-default-20260709|mid|16|0|16-32K|3"
  "mid_gdn8_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|8|0|4-8K|3"
  "mid_gdn16_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|16|0|4-8K|3"
  "mid_gdn16_fla_4_8|experiment/tile64-mid-gdn-conv-20260709|mid|16|1|4-8K|3"
  "mid_gdn16_8_16|experiment/tile64-mid-gdn-conv-20260709|mid|16|0|8-16K|3"
)
...
case "$RUN_PROFILE" in
  ...
  full)
    ...
    ;;
  *)
    echo "ERROR: RUN_PROFILE must be quick, gdn, or full" >&2
    exit 1
    ;;
esac
...
printf "case\tref\tpolicy\tgdn_block\tfla_fix_bt\trange\tnum_prompts\tstatus\tresult_dir\n" \
  > "$summary"

for line in "${selected_cases[@]}"; do
    IFS='|' read -r label ref tile_policy gdn_block fla_fix range num_prompts <<< "$line"
    case_out="$OUT_ROOT/$label"
    mkdir -p "$case_out"

    echo
    echo "=== case $label ==="
    echo "ref=$ref policy=$tile_policy gdn_block=$gdn_block fla_fix=$fla_fix range=$range prompts=$num_prompts"
    ...
    printf "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n" \
        "$label" "$ref" "$tile_policy" "$gdn_block" "$fla_fix" \
