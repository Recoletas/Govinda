...
case_lines_attn=(
  "mid_attn_base_8_16|experiment/tile64-mid-default-20260709|mid|16|64|0|ieee|0|||8-16K|3"
  "mid_attn_w2_8_16|experiment/mid-attn-launch-knobs-20260709|mid|16|64|0|ieee|0|2||8-16K|3"
  "mid_attn_w4_8_16|experiment/mid-attn-launch-knobs-20260709|mid|16|64|0|ieee|0|4||8-16K|3"
...
for line in "${selected_cases[@]}"; do
    IFS='|' read -r label ref tile_policy gdn_block gdn_chunk fla_fix tril_precision llmm1silu prefill_warps prefill_dot range num_prompts <<< "$line"
