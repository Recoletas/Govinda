...
> 注：本表区分 **plan-level 任务交付** (artifacts 落地) 与 **CP gate 状态** (实际产出是否达标)。CP 通过靠 bench 跑分 / 精度 / 集成日 ROI, **不靠 4 签 checkbox** (sign-off 模板已删, 见 [AGENTS.md Changelog](AGENTS.md#changelog))。
